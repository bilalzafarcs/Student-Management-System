...
<div class="w3-teal">
  ...
  <nav class="navbar navbar-expand-md bg-dark "><h3 class="text-center navhead">Update Your Profile</h3>
...
<div class="cotainer" style="padding-top:25px">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          <div class="card-body">
            <?php echo form_open_multipart('update/updateprof'); ?>
            <?php if ($this->session->flashdata()) { ?>
                            <div class="alert alert-success">
                                <?= $this->session->flashdata('msg'); ?>
                            </div>
             <?php } ?>
             <input type="text" id="user_id" class="form-control" value="<?php echo $this->session->userdata('user_id'); ?>">
            <div class="form-group row">
              <label for="email_address" class="col-md-4 col-form-label text-md-right">Name</label>
              <div class="col-md-6">
                <input type="text" id="name" class="form-control" name="name" value="<?php echo $this->session->userdata('name'); ?>" required autofocus>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" id="email" class="form-control" name="email" value="<?php echo $this->session->userdata('email'); ?>" required autofocus>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" id="contactnumber" class="form-control" name="contactnumber" value="<?php echo $this->session->userdata('contactnumber'); ?>" required autofocus>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input type="text" id="cnic" class="form-control" name="cnic" value="<?php echo $this->session->userdata('cnic'); ?>" required autofocus>
              </div>
            </div>
